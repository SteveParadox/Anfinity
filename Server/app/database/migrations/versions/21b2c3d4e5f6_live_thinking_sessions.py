...
def upgrade() -> None:
    THINKING_SESSION_PHASE_ENUM.create(op.get_bind(), checkfirst=True)
    THINKING_SYNTHESIS_STATUS_ENUM.create(op.get_bind(), checkfirst=True)
    ...
    op.create_index("ix_thinking_sessions_workspace_id", "thinking_sessions", ["workspace_id"])
    op.create_index("ix_thinking_sessions_note_id", "thinking_sessions", ["note_id"])
    op.create_index("ix_thinking_sessions_room_id", "thinking_sessions", ["room_id"])
    op.create_index("ix_thinking_sessions_created_by_user_id", "thinking_sessions", ["created_by_user_id"])
    op.create_index("ix_thinking_sessions_host_user_id", "thinking_sessions", ["host_user_id"])
    op.create_index("ix_thinking_sessions_phase", "thinking_sessions", ["phase"])
    op.create_index("ix_thinking_sessions_active_synthesis_run_id", "thinking_sessions", ["active_synthesis_run_id"])
    op.create_index("ix_thinking_sessions_last_refined_by_user_id", "thinking_sessions", ["last_refined_by_user_id"])
    op.create_index("ix_thinking_sessions_created_at", "thinking_sessions", ["created_at"])
    op.create_index("ix_thinking_sessions_updated_at", "thinking_sessions", ["updated_at"])
    op.create_index(
        "idx_thinking_sessions_workspace_phase",
        "thinking_sessions",
        ["workspace_id", "phase", "updated_at"],
    )
    op.create_index(
        "idx_thinking_sessions_host_phase",
        "thinking_sessions",
        ["host_user_id", "phase", "updated_at"],
    )
    ...
    op.create_index("ix_thinking_session_participants_session_id", "thinking_session_participants", ["session_id"])
    op.create_index("ix_thinking_session_participants_user_id", "thinking_session_participants", ["user_id"])
    op.create_index("ix_thinking_session_participants_joined_at", "thinking_session_participants", ["joined_at"])
    op.create_index("ix_thinking_session_participants_last_seen_at", "thinking_session_participants", ["last_seen_at"])
    op.create_index(
    ...
    op.create_index("ix_thinking_session_contributions_session_id", "thinking_session_contributions", ["session_id"])
    op.create_index("ix_thinking_session_contributions_author_user_id", "thinking_session_contributions", ["author_user_id"])
    op.create_index("ix_thinking_session_contributions_created_at", "thinking_session_contributions", ["created_at"])
    op.create_index("ix_thinking_session_contributions_updated_at", "thinking_session_contributions", ["updated_at"])
    op.create_index(
    ...
    op.create_index("ix_thinking_session_votes_session_id", "thinking_session_votes", ["session_id"])
    op.create_index("ix_thinking_session_votes_contribution_id", "thinking_session_votes", ["contribution_id"])
    op.create_index("ix_thinking_session_votes_user_id", "thinking_session_votes", ["user_id"])
    op.create_index("ix_thinking_session_votes_created_at", "thinking_session_votes", ["created_at"])
    op.create_index(
    ...
    op.create_index("ix_thinking_session_synthesis_runs_session_id", "thinking_session_synthesis_runs", ["session_id"])
    op.create_index("ix_thinking_session_synthesis_runs_triggered_by_user_id", "thinking_session_synthesis_runs", ["triggered_by_user_id"])
    op.create_index("ix_thinking_session_synthesis_runs_status", "thinking_session_synthesis_runs", ["status"])
    op.create_index("ix_thinking_session_synthesis_runs_created_at", "thinking_session_synthesis_runs", ["created_at"])
    op.create_index("ix_thinking_session_synthesis_runs_updated_at", "thinking_session_synthesis_runs", ["updated_at"])
    op.create_index(
    ...
    op.execute(
        """
        CREATE UNIQUE INDEX uq_thinking_session_single_streaming_run
